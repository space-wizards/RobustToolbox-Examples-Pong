#!/usr/bin/env python3
# Packages a full release build that can be unzipped and you'll have your Pong server.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Packages the Pong content repo for release on all platforms.")
...
def build_platform(platform: PlatformReg, skip_build: bool) -> None:
    ...
    server_zip = zipfile.ZipFile(p("release", f"Pong.Server_{platform.rid}.zip"), "w",
